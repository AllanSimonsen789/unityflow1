...
public class AimBehaviourBasic : GenericBehaviour
{
	...
	public Vector3 aimPivotOffset = new Vector3(0f, 0f,  0f);         // Offset to repoint the camera when aiming.
	public Vector3 aimCamOffset   = new Vector3(0f, 0f, 0f);         // Offset to relocate the camera when aiming.
	// public Vector3 aimPivotOffset = new Vector3(0.5f, 1.2f,  0f);         // Offset to repoint the camera when aiming.
	// public Vector3 aimCamOffset   = new Vector3(0f, 1.4f, -0.7f);         // Offset to relocate the camera when aiming.
